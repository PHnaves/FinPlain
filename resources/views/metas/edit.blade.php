<x-app-layout>
    ...
    <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Card de publicidade -->
            <div class="h-[500px] md:h-[600px] bg-gradient-to-br from-indigo-500 to-indigo-700  text-white rounded-lg shadow-md p-4 flex flex-col justify-between">
                <div>
                ...
                <div class="mt-4">
                    <img src="{{ asset('/images/Metas-removebg.png') }}" alt="Dicas" class="w-full h-auto max-h-[300px] object-contain">
                </div>
            </div>
        </div>
    </div>
