    ...
    <div class="container mt-5">
        ...
        <div class="mb-4">
            ...
            <ul>
                ...
                <li>Projeções financeiras fictícias</li>
            </ul>
        </div>
        ...
        <div class="mb-4">
            ...
            <p>O uso dos serviços requer o fornecimento de informações verdadeiras no momento do cadastro. Você deve manter essas informações atualizadas e proteger seus dados de login.</p>
        </div>
        ...
        <div class="mb-4">
            ...
            <p>Reservamo-nos o direito de modificar ou descontinuar funcionalidades sem aviso prévio. Só avisaremos se tal funcionalidade afetar os usuários de maneira grave.</p>
        </div>
    </div>
</body>
</html>