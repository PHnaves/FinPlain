<nav x-data="{ open: false }" class="bg-primary-1 border-b border-primary-1">
        ...
        <div class="flex justify-between h-16 pt-10">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center pb-3">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block fill-current text-white" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 pb-3 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-primary-1 focus:outline-none transition ease-in-out duration-150">
            ...
            <!-- Hamburger -->
            <div class="-me-2 flex items-center sm:hidden pr-3">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-5 space-y-1 text-white">
